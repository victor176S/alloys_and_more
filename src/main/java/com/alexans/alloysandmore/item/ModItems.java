...
import com.alexans.alloysandmore.AlloysAndMoreClient;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item){
        return Registry.register(Registries.ITEM, new Identifier(AlloysAndMore.MOD_ID, name),item);
    }

    public static void registerModItems(){
        AlloysAndMore.LOGGER.info("Registrando Items para el mod " + AlloysAndMore.MOD_ID);
